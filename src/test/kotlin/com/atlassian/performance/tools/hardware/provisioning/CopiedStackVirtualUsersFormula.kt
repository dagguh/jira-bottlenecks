 ...
 */
class CopiedStackVirtualUsersFormula private constructor(
    ...
    private val overriddenNetwork: CopiedNetwork? = null,
    ...
    override fun provision(
        ...
        val virtualUsersIp = if(usePrivateIps) virtualUsersMachine.privateIpAddress else virtualUsersMachine.publicIpAddress
        ...
        val jarPath = CopiedUbuntuVirtualUsersRuntime().prepareForExecution(
            virtualUsersSsh,
            shadowJar,
            shadowJarTransport,
            browser
    ...
    class Builder(
        ...
        private var usePrivateIps = false

        internal constructor(
            formula: CopiedStackVirtualUsersFormula
        ) : this(
        ...
        internal fun network(network: CopiedNetwork): Builder = apply { this.network = network }
        fun usePrivateIps(usePrivateIps: Boolean) :Builder = apply { this.usePrivateIps = usePrivateIps }

        fun build(): CopiedStackVirtualUsersFormula = CopiedStackVirtualUsersFormula(
            nodeOrder = nodeOrder,
            shadowJar = shadowJar,
            splunkForwarder = splunkForwarder,
            browser = browser,
